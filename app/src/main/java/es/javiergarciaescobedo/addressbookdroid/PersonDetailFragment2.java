...
//        }
        ...
        if(person != null) {
            ((TextView) rootView.findViewById(R.id.textViewAddress)).setText(person.getAddress());
            ((TextView) rootView.findViewById(R.id.textViewPostCode)).setText(person.getPostCode());
            ((TextView) rootView.findViewById(R.id.textViewCity)).setText(person.getCity());
            ((TextView) rootView.findViewById(R.id.textViewProvince)).setText(person.getProvince());
        }
